...
class Settings {
    ...
    fromJson(content) {
        ...
        this.hColor1 = obj['hColor1'];
        this.hColor2 = obj['hColor2'];
        this.hColor3 = obj['hColor3'];
        this.hColor4 = obj['hColor4'];
        this.hColor5 = obj['hColor5'];
    }
}
...
class MyPlugin extends obsidian.Plugin {
    ...
    onload() {
        ...
        noticeContent.createEl("p").innerHTML = "<b>欢迎使用 ZH增强编辑 插件！</b>";
        noticeContent.createEl("p").innerHTML = "本插件旨在增强Obsidian笔记的文本编辑能力，提升用户操作手感，目前从Markdwon语法设置、转换格式、选择文本、批量增减等方面进行增强，如有功能建议，敬请留言！";
        noticeContent.createEl("button").innerHTML = "开发：蚕子 <a href='https://www.runoob.com/tags/ref-eventattributes.html'>QQ：312815311</a>";
        noticeContent.createEl("p").innerHTML = "点击此处可以关闭提示窗口......";
...
class editSettingsTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        containerEl.empty();
        containerEl.createEl('h2', { text: 'ZH增强编辑 0.4.5' });
        ...
        .addText(text => {
            text
                ...
                .onChange((value) => {
                this.plugin.settings.hColor5 = value;
                this.plugin.saveSettings();
            });
        });
